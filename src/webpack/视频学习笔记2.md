...
//四个启动指令
 "scripts": {
    ...
    "eject": "react-scripts eject"// 默认情况下webpack配置是在react-scripts包里面的 所以启动时是通过react-scripts库帮我们启动，为了方便，提供了eject指令负责将react_scripts中的webpack配置打包到外面出来，会在外面多两个目录存放webpack配置，这样我们可以修改webpack
  },
```
...
const publicUrlOrPath = getPublicUrlOrPath(
  ...
  require(resolveApp('package.json')).homepage, // 找package.json文件然后引进来看package.json上有没有home属性， 如果有homepage则表示我们的公开路径以homepage开头
